...
The latest stable version of this library is <a href="http://markkolich.github.com/repo/com/kolich/havalo-client/1.1.3">1.1.3</a>.
...
val havaloClient = "com.kolich" % "havalo-client" % "1.1.3" % "compile"
```
...
In SBT, run `package` to compile and package the JAR.
    ...
    havalo-client:1.1.3> package
    [info] Compiling 12 Java sources to ~/havalo-client/target/classes...
    [info] Packaging ~/havalo-client/dist/havalo-client-1.1.3.jar ...
    [info] Done packaging.
